...
ActiveRecord::Schema[7.0].define(version: 2022_10_13_063028) do
  ...
  create_table "street_categories", force: :cascade do |t|
    t.integer "street_id", null: false
    t.integer "category_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["category_id"], name: "index_street_categories_on_category_id"
    t.index ["street_id"], name: "index_street_categories_on_street_id"
  end
